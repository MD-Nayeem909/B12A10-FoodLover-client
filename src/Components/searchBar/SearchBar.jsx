  ...
  return (
    <div className="w-full">
      <div className="relative flex items-center justify-center font-sans w-full px-4 py-8">
        {}
        <div className="w-full max-w-2xl mx-auto p-4 space-y-6 bg-primary/20 text-accent-content backdrop-blur-3xl border border-base-300 rounded-3xl shadow-lg">
          {}
          <div className="relative p-px rounded-2xl ocean-animated-gradient shadow-lg shadow-primary/20  transition-shadow duration-300 hover:shadow-primary/30 focus-within:shadow-primary/40">
            <div className="flex items-center w-full px-4 py-2 bg-base-100/80 rounded-[15px]">
              <SearchIcon className="w-5 h-5 text-neutral flex-shrink-0" />
              <input
                type="text"
